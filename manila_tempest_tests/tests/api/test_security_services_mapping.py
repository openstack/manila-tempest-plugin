...
class SecurityServicesMappingTest(base.BaseSharesTest):
    ...
    def setUp(self):
        ...
        self.sn = self.create_share_network(add_security_services=False,
                                            version='2.0',
                                            **data)
        ...
        self.ss = self.create_security_service(
    ...
    def test_map_ss_to_sn_and_list(self):
        ...
        ls = self.shares_v2_client.list_sec_services_for_share_network(
