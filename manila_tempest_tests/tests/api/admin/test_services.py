...
class ServicesAdminTest(base.BaseSharesAdminTest):
    ...
    def setUp(self):
        ...
        self.services = self.shares_v2_client.list_services()['services']

    @decorators.idempotent_id('74cd12ab-a1f5-40fb-9110-d9035b4b20c5')
    @tc.attr(base.TAG_POSITIVE, base.TAG_API)
    def test_list_services(self):
        services = self.shares_v2_client.list_services()['services']
    ...
    def test_get_services_by_host_name(self):
        ...
        params = {"host": host}
        services = self.shares_v2_client.list_services(params)['services']
        self.assertNotEqual(0, len(services))
        for service in services:
